...
#################### TRAIN ####################
stats = learner.train_model(args.n_epochs, train_loader, val_loader, net, criterions, optimizer, args.device, scheduler, args.patience, args.outfile, args.n_steps, ff=True)
