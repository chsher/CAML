...
for k,v in zip(script_utils.PARAMS[:-10] + ['N_TRAIN', 'N_TEST', 'TRAIN_SIZE', 'VAL_SIZE', 'TRAIN_MU', 'TRAIN_SIG'], values + [args.n_testtrain, args.n_testtest, len(train), len(val), mu, sig]):
